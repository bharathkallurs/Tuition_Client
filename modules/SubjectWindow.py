...
#define a class to showcase the subject window
class WindowSubject(QtGui.QWidget) :
	gridNames = ["Phyics","Chemistry","Math","Biology","CS","EC"]

	subjectProps = ["Videos","Assignments"]
	...
	def WindowSubUI(self):
		...
		for i in self.subjectProps :
			...
			button.move(j+20,10)
			j += 30
			#On clicking this, you load the tiles window of corresponding subject property
			button.clicked[bool].connect(self.selectSubTileWindow)
	...
	#Manu will call Tile Window here
"""